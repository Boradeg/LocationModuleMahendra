...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        try {
            ...
            //val nearestLocation = createLocation(19.99727000, 73.79096000,"Nashik")

            if (nearestLocation?.second != null) {
                ...
                for (location in deviceLocations) {
                    ...
                    if (result.first != null && result.second != null) {
                        ...
                        Toast.makeText(
                            this,
                            "Distance between ${origin.second} and ${location.second}: $distance km",
                            Toast.LENGTH_SHORT
                        ).show()
    ...
    private fun findNearestLocation(
        origin: Pair<LatLng, String>, destinations: List<Pair<LatLng, String>>
    ): Pair<LatLng, String>? {
